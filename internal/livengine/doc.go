...
// signal per strategy per bar (and emits a PortfolioHealthSnapshot) but
...
// VirtualClock must emit signals IDENTICAL
...
//   - call EvaluateSignal at the SAME points (after every strategy's OnBar at a
