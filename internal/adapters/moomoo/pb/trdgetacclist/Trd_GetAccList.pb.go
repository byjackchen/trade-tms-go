...
const file_Trd_GetAccList_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x13.Trd_GetAccList.S2CR\x03s2cBc\n" +
	"\x13com.futu.openapi.pbZLgithub.com/byjackchen/trade-tms-go/internal/adapters/moomoo/pb/trdgetacclist"
