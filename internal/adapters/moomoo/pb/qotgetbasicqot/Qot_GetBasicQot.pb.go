...
const file_Qot_GetBasicQot_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x14.Qot_GetBasicQot.S2CR\x03s2cBd\n" +
	"\x13com.futu.openapi.pbZMgithub.com/byjackchen/trade-tms-go/internal/adapters/moomoo/pb/qotgetbasicqot"
