...
const file_Trd_GetFunds_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x11.Trd_GetFunds.S2CR\x03s2cBa\n" +
	"\x13com.futu.openapi.pbZJgithub.com/byjackchen/trade-tms-go/internal/adapters/moomoo/pb/trdgetfunds"
