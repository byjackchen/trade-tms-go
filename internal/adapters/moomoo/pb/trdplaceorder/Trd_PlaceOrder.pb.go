...
const file_Trd_PlaceOrder_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x13.Trd_PlaceOrder.S2CR\x03s2cBc\n" +
	"\x13com.futu.openapi.pbZLgithub.com/byjackchen/trade-tms-go/internal/adapters/moomoo/pb/trdplaceorder"
