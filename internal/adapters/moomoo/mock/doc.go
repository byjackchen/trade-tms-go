...
//
// Layer: outbound adapter / test fixture (peer of internal/adapters/moomoo). It
...
//
// May import: internal/domain, internal/adapters/moomoo (the client + framing it
// mirrors), the generated internal/adapters/moomoo/pb/* protobuf messages, and
