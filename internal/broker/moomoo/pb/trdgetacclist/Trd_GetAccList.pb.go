...
const file_Trd_GetAccList_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x13.Trd_GetAccList.S2CR\x03s2cBa\n" +
	"\x13com.futu.openapi.pbZJgithub.com/byjackchen/trade-tms-go/internal/broker/moomoo/pb/trdgetacclist"
