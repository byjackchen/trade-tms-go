...
//     composed by Portfolio with first-rejection-wins ordering and the exact
...
// and the engine glue that builds a ProposedOrder + AccountSnapshot per signal
// and feeds Portfolio.Check at submission time.
package portfolio
