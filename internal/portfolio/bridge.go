...
// AccountSnapshot, money as `dec`). It is the single seam between the
...
// SnapshotFromDomain converts a domain.AccountSnapshot (the accounting layer's
// view) into the portfolio gating AccountSnapshot. NAV and Cash both come from
...
func SnapshotFromDomain(s domain.AccountSnapshot) AccountSnapshot {
