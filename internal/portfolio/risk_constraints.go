...
func (r *RiskConstraints) Check(order ProposedOrder, account AccountSnapshot) RiskDecision {
...
func (r *RiskConstraints) checkDailyLossHalt(account AccountSnapshot) RiskDecision {
...
func (r *RiskConstraints) checkMaxSingleName(order ProposedOrder, account AccountSnapshot) RiskDecision {
...
func (r *RiskConstraints) checkConcentration(order ProposedOrder, account AccountSnapshot) RiskDecision {
