 ...
 *
 * `variant="portfolio"` (default): reads the strategy session's account
...
export function AccountPanel({
  ...
  accountId?: string;
  variant?: "portfolio" | "desk";
} = {}) {
  if (variant === "desk") {
    return <DeskAccountPanel />;
  }
  return <PortfolioAccountPanel accountId={accountId} />;
}

function PortfolioAccountPanel({ accountId }: { accountId?: string }) {
