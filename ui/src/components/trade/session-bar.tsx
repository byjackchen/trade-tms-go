...
import { ModeBadge, SessionStatusBadge, StatusDot } from "./live-badges";
...
/**
 * The cockpit's at-a-glance session strip: mode, status, trader, start time and
    ...
    return (
      ...
      >
        ...
        <span className="text-sm text-muted-foreground">
          Live reader not configured on the API — the cockpit is read-only and
